---
id: "_ctx.Recover-a-lost-path-from-outside-use-to-recursive-builders"
title: Recover a lost path from outside use to recursive builders
---

# _ctx.Recover-a-lost-path-from-outside-use-to-recursive-builders: Recover a lost path from outside use to recursive builders
