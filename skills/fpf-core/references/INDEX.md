...
| A.16.2 | Reopen / SketchBackoff / Respecify | reopen, backoff, respecify, retire, retreat |
| A.17 | A.CHR-NORM — Canonical “Characteristic” & rename (Dimension/Axis → Characteristic) | characteristic, measurement, property, attribute, dimension |
| A.18 | A.CSLC-KERNEL — Minimal CSLC in Kernel (Characteristic/Scale/Level/Coordinate) | CSLC, Characteristic, Scale, Level, Coordinate |
| A.19 | CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE) | CharacteristicSpace, U.Dynamics.stateSpace, state trajectories, declared Characteristics and Scales, subspace |
| A.19.ECS | Evaluation CharacteristicSpace Construction | — |
| A.19.SPR | State-Family Precision Restoration | — |
| A.19.SOURCE-SET-SPACE-SUBSTRATE | A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search/Outcome-Space Substrate | — |
| A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW | A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View | — |
| A.19.CN | CN-frame (comparability & normalization) | CN-frame, CN-Spec, chart, comparability modes, normalization refs |
| A.19.CHR | `CHRMechanismSuite` — CHR mechanism-suite anchor (suite obligations + P2W planned baseline) | CHR suite, characterization core, CN-Spec, CG-Spec, admissibility gate |
| A.19.UNM | Unified Normalization Mechanism (UNM) | normalization, `CV→NCV`, `≡_UNM`, `NormalizationMethodId`, `NormalizationMethodInstanceId` |
| A.19.UINDM | Unified Indicatorization Mechanism (UINDM) | indicatorization, indicator set, `IndicatorChoicePolicy`, `CN-Spec.indicator_policy`, CHR suite stage `indicatorize` |
| A.19.USCM | Unified Scoring Mechanism (USCM) | scoring, score profile, `ScoringMethodDescription`, ScaleComplianceProfile (SCP), CSLC-lawful transforms |
...
| C.2.3 | Unified Formality Characteristic F | Formality, F-scale, F0-F9, rigor, proof |
| C.2.LS | `U.LanguageStateFacetProfile` - Thin profile bundle for language-state facets | facet profile, articulation, closure, anchoring, representation factors |
| C.2.4 | `U.ArticulationExplicitness` | articulation explicitness, semantic shape, under-articulated cue, explicitness, early repair readiness. |
...
| C.26 | Quantum-Like Modeling Lens | quantum-like, QL-lite, QL-NQ, probe frame, order effect |
...
| E.2 | The Eleven Pillars | principles, constitution, pillars, invariants, core values |
...
| E.5.3 | Unidirectional Dependency | dependency, layers, architecture, modularity, acyclic |
| E.5.4 | Cross-Disciplinary Bias Audit | bias, audit, ethics, fairness, trans-disciplinary |
...
| G.0 | CG-Spec — Frame Standard & Comparability Governance | CG-Spec, CG-Frame, admissibility gate, ComparatorSet, ScaleComplianceProfile (SCP) |
